...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 4rem; padding-top: 4rem; margin-top: 6rem; border-top: 1px solid #334155;">
  ...
  <div style="flex: 1; display: flex; gap: 5rem; align-items: baseline; justify-content: flex-end; min-width: 300px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 0.85rem; font-size: 0.9rem;">
      ...
      <a href="/spec/" style="text-decoration: none; color: #94a3b8;">The Specification</a>
      <a href="/relay/" style="text-decoration: none; color: #94a3b8;">Go Relay Service</a>
    ...
    <div style="display: flex; flex-direction: column; gap: 0.85rem; font-size: 0.9rem;">
      ...
      <a href="https://github.com/open-outbox" target="_blank" rel="noopener" style="text-decoration: none; color: #94a3b8;">GitHub</a>
      <a href="/spec/contributing/" style="text-decoration: none; color: #94a3b8;">Contribute</a>
    </div>
